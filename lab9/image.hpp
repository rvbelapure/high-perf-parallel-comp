...
void matrix_vector_multiplication_upper(double* output_vector, const double* matrix, const double* input_vector, size_t matrix_width, size_t matrix_height);
void matrix_vector_multiplication_lower(double* output_vector, const double* matrix, const double* input_vector, size_t matrix_width, size_t matrix_height);
